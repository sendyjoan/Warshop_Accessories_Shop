                    ...
                    <div class="md:grid md:grid-cols-3 gap-2 ">
                        ...
                        <div class=" p-5 bg-gray-800 rounded overflow-visible">
                            ...
                            <div class="flex justify-center flex-col pt-3">
                                ...
                                <select name="kurir"
                                    class="bg-gray-800 text-white py-2 text-sm border-b border-gray-600">
                                    <option selected
                                        class="focus:outline-none w-full h-6 bg-gray-800 text-white placeholder-gray-300 text-sm border-b border-gray-600 py-4"
                                        value="JNE Express">JNE Express</option>
                                    <option
                                        class="focus:outline-none w-full h-6 bg-gray-800 text-white placeholder-gray-300 text-sm border-b border-gray-600 py-4"
                                        value="J&T Express">J&T Express</option>
                                    <option
                                        class="focus:outline-none w-full h-6 bg-gray-800 text-white placeholder-gray-300 text-sm border-b border-gray-600 py-4"
                                        value="Ninja Express">Ninja Express</option>
                                </select>
                            </div>
                            <div class="flex justify-center flex-col pt-3">
                                ...
                                <select name="kurir"
                                    ...
                                    <option
                                        class="focus:outline-none w-full h-6 bg-gray-800 text-white placeholder-gray-300 text-sm border-b border-gray-600 py-4"
                                        value="COD">Cash on Delivery (COD)</option>
                                </select>
                            </div>
                            <!-- {{--  If COD maka checkout langsung selesai  --}}
                            {{--  If Transfer bank ke halaman pembayaran  --}} -->
                            <div>.</div>
                            <button class="h-12 w-full rounded focus:outline-none text-white"
