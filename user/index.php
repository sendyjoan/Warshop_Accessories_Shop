            ...
            <div class="container ">
                <div class="row">
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="../public/assets/images/o1.jpg" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Tasty Thursdays
                    ...
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="../public/assets/images/o2.jpg" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Pizza Days
    ...
    <section class="food_section layout_padding-bottom">
        <div class="container">
            ...
            <div class="filters-content">
                <div class="row grid">
                    <div class="col-sm-4 col-lg-3 all burger">
                        <div class="box">
                            <div>
                                <div class="img-box">
                    ...
                    <div class="col-sm-4 col-lg-3 all pasta">
                        <div class="box">
                            <div>
                                <div class="img-box">
                    ...
                    <div class="col-sm-4 col-lg-3 all fries">
                        <div class="box">
                            <div>
                                <div class="img-box">
                ...
                <div class="owl-carousel client_owl-carousel">
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img src="../public/assets/images/client1.jpg" alt="" class="box-img">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img src="../public/assets/images/client2.jpg" alt="" class="box-img">
                            </div>
                        </div>
                    </div>
                </div>
